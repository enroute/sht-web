...
$(function() {
    ...
    var height1=$(".row:first").height();
    var height2=$(".row:last").height();
    var height3=$(".loginbtn").height(); 
    var height4=parseInt($(".loginbtn").css("margin-top"));
    var height5=$(".tiprow").height();
    var height6=parseInt($(".tiprow").css("margin-top"));
    var height7=parseInt($(document.body).css("padding-top"));
    var btnHeight=$(".openshop").height();
    var tempHeight1=totalHeight-btnHeight;
    var tempHeight2=height1+height2+height3+height4+height5+height6+height7*2;
    var scopeHeight=tempHeight1-tempHeight2;
    
    $(".openshop").css("margin-top",scopeHeight+"px");
