 ...
 // function LotteryRelateActivity(key) {
 //   $(".hid_key").each(function() {
 //     var ckey = $(this).val();
 //     $.ajax({
 //       url: globalData.apiBusiness + 'LotteryContactCoupon.aspx',
 //       dataType: 'json',
 //       async: false,
 //       data: {
 //         "session": session,
 ...
 function selectStartDate() {
   ...
   //     $("#hid_startDate").val(date);
   //     $("#sel_startDate").text(date);
   //   },
   //   id: 'datePicker1'
   // });
 ...
 function selectEndDate() {
   ...
   // weui.datePicker({
   //   start: startDate || nowFormat, // 从今天开始
   //   end: 2030,
   //   defaultValue: [now.getFullYear(), now.getMonth() + 1, now.getDate()],
   //   onChange: function(result) {
   //     console.log(result);
   ...
   //     console.log(result);
   //     var date = result[0].value + "-" + result[1].value + "-" + result[2].value;
   //     $("#hid_endDate").val(date);
   //     $("#sel_endDate").text(date);
   //   },
   //   id: 'datePicker2'
   // });
